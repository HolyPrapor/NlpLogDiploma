...
class TestModel(ModelInterface):
    ...
    def __init__(self):
        self.prob = [(Token(1), 0.5), (Token(2), 0.25),
                     (Token(3), 0.125), (Token(4), 0.125)]
        self.token_by_symbol = {'a': Token(1), 'b': Token(
            2), 'c': Token(3), '': Token(4)}
        self.symbol_by_token = {Token(1): 'a', Token(
            2): 'b', Token(3): 'c', Token(4): ''}
